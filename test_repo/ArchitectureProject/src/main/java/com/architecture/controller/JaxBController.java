...
public class JaxBController {
	...
	public static void sendBuildingById(HttpServletRequest req, HttpServletResponse resp) {
//		String sid = req.getParameter("id");
//		int id = Integer.parseInt(sid);
//		Building b1 = BuildingService.getById(id);
//		JaxBBuilding j = new JaxBBuilding(b1);
		
		JaxBBuilding b = new JaxBBuilding(BuildingService.getById(
		...
		try {
			...
			marsh.marshal(b, resp.getWriter());
		}
		catch(Exception e) {
			e.printStackTrace();
		}
